<template>
  <div>
    ...
    <div class="container mt-3 mb-5">
      <div class="row">
        <div class="col-1"></div>
<h3 class="mb-3 col-10">Meal Plan</h3>
      </div>
      <form action="post" class="row">
        <div class="col-11 px-0">
<input class="form-control" type="text" v-model="newMeal" placeholder="Add new meal" maxlength="30" />
        </div>
      ...
      <img v-if="this.plannedItems.length == 0" class="illustration mt-5 mb-3" src="../assets/meal-illustration.svg">
      <p v-if="this.plannedItems.length == 0" class="mb-3">Add new meals or choose from your cookbook</p>
      <div class="row">
<p v-if="this.plannedItems.length >= 1" class="px-2 my-4 font-small"><transition name="fade" mode="out-in"><span :key="plannedItems.length">{{ plannedItems.length}}</span></transition> meal(s) planned</p>
      </div>
      ...
      <div class="row mt-5 mb-3">
        <div class="col-1"></div>
        <h3 class="col-10" @click="hideItemlist = !hideItemlist">Cook Book</h3>

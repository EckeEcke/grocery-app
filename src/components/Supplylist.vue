  ...
  <div>
    <div class="container mt-3 mb-5">
      ...
      <div class="row mt-5 mb-3">
        <div class="col-1 mb-2 bg-light"></div>
        <h3 class="col-10 bg-light" @click="hideItemlist = !hideItemlist">Item List</h3>
        <h3 class="col-1 mb-2 px-0 bg-light" @click="hideItemlist = !hideItemlist">
          <font-awesome-icon
            :icon="['fas', 'chevron-up']"
            ...
            >
              <div class="col-11 text-nowrap overflow-hidden px-0 mx-0">
                <button
                  ...
                  :class="
                    item.planned ? 'btn-success' : 'btn-outline-secondary'
                  "
                  :key="item.id"
              ...
              <div class="col-1 px-0 mx-0">
                <button
                  class="btn btn-outline-secondary align-bottom delete-item-btn"
                  @click="deleteItem(listData, item.name)"
                >
                  <font-awesome-icon
                    :icon="['fas', 'trash-alt']"
                    class="trash-icon-item"
